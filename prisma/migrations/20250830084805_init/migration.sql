-- CreateEnum
CREATE TYPE "ProposalStatus" AS ENUM ('PENDING', 'APPROVED', 'ARCHIVED');

-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('PROPOSE', 'VOTE', 'UNVOTE', 'ADMIN_EDIT', 'ADMIN_DELETE', 'ADMIN_ARCHIVE', 'ADMIN_UNARCHIVE');
